...
import PettyCashReportPreview from "./PettyCashReportPreview";

function PettyCashReport({ handleLogout, username }) {
  ...
  // sidebar SearchBar 
    ...
    const calculateTotals = () => {
        const totals = ledgerEntries.reduce((acc, record) => {
            acc.totalProject += 1;
    ...
    const handleDetails = () => {
        ...
        setSelectedRecord({
            ...
            status: ledgerEntries.length > 0 ? ledgerEntries[0].status : '',
            recordData: ledgerEntries,
            selectedMonth,
            selectedYear
        });
    ...
    const handleProjectChange = (projectId) => {
        ...
        // Do not reset month and year when the project changes
    };
