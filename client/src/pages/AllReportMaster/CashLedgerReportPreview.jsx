...
const CashLedgerReportPreview = ({ record, onClose }) => {
            ...
            <div className="row p-1">
                <div className="modal-content">
                    <div className="modal-header m-0 p-2 d-flex align-items-center justify-content-between px-3">
                        ...
                        <h4 style={{ color: "#00509d" }} className='title-detail text-uppercase fw-bolder font-bold m-0'>Payment Report</h4>
...
export default CashLedgerReportPreview;
...
//                                     <div className="nunito text-white">Total Expenses - This Month:{getMonthName(selectedMonth)} {totalExpenseMonth}</div>
//                                     <div className="nunito text-white">Total Expenses - This Year:{selectedYear} {totalExpenseYear}</div>