...
const ExpensesCashReportPreview = ({ record, onClose }) => {
            ...
            <div className="row p-1">
                <div className="modal-content">
                    <div className="modal-header m-0 p-2 d-flex align-items-center justify-content-between px-3">
                        ...
                        <h4 style={{ color: "#00509d" }} className='title-detail text-uppercase fw-bolder font-bold m-0'>Expenses Ledger Report</h4>
                    ...
                    <div className="card-body form-row">
                        <div className='col-md-12'>
                            <table className="table table-striped table-bordered rounded border">
                                ...
                                <tfoot>
                                    <tr>
                                        <th>Total {grandTotals.totalEmployees}</th>
                                        <th></th>
                                        <th></th>
                                        <th></th>
                                        <th></th>
...
export default ExpensesCashReportPreview;
