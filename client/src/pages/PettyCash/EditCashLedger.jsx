...
// const EditCashLedger = ({ onClose, onUpdate, ledgerChanges }) => {
...
//     useEffect(() => {
//         if (ledgerChanges) {
//             setFormData({ ...ledgerChanges });
//         }
//     }, [ledgerChanges]);

//     // Fetch payment modes and projects
//     useEffect(() => {
...
//         try {
//             const response = await axios.put(`${process.env.REACT_APP_LOCAL_URL}/addCashPayment/${formData.id}`, formData);
//             console.log('Cash payment updated successfully:', response.data);
...
//     return (
//         <div id="editCashModal" className="modal fade show" role="dialog" style={{ display: 'block' }}>
...
//                             <h5 className="modal-title">Edit Cash Payment</h5>
...
const EditCashLedger = ({ onClose, onUpdate, ledgerChanges }) => {
    ...
    return (
        <div id="EditCashLedgerModal" className="modal fade show" role="dialog" style={{ display: 'block' }}>
            <div style={{ borderRadius: '20px' }} className="modal-dialog modal-lg overflow-hidden">
                <div className="modal-content">
                    <form onSubmit={handleSubmit} autoComplete="off" noValidate>
                        <div style={{ backgroundColor: '#00509d', color: 'white' }} className="modal-header">
