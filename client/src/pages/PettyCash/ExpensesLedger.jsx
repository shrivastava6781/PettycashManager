...
import ViewPicture from "../UserDetails/EntryLedger/ViewPicture";
import UpdateProjectEntry from "../UpdateProjectEntry.jsx/UpdateProjectEntry";

function ExpensesLedger({ handleLogout, username }) {
    ...
    const handleCloseModal = () => {
        ...
        const handleDeleteConfirmation = async () => {
            try {
                await axios.delete(`${process.env.REACT_APP_LOCAL_URL}/deleteexpensesledger/${deleteCashLedger.id}`);
                                                        ...
                                                        {filteredRecords.length === 0 ? (
                                                            ...
                                                            filteredRecords.map((entry, index) => (
                                                                <tr key={index}>
                                                                    ...
                                                                    <td>
                                                                        <button style={{whiteSpace:"nowrap"}} onClick={() => handleViewpictureModal(entry)} className="tablefont nunito m-0 p-1 button_action">
