...
// const EditProject = ({ onClose, onUpdate, project }) => {
...
//                                     <label>Employeer Name<span style={{ color: "red" }}>*</span></label>
//                                     <input
//                                         name="employeerName"
//                                         type="text"
...
const AddProjectModal = ({ onClose, onUpdate, project }) => {
    const [isLoading, setIsLoading] = useState(false);
    const [formData, setFormData] = useState({
        projectName: '',
        projectShortName: '',
    ...
    useEffect(() => {
        if (project) {
            setFormData({ ...project });  // Initialize form data with project prop
        }
    }, [project]);
